...
INSERT INTO `recipe` (`title`, `description`, `approximate_completion_time`, `public`) VALUES
    ('Fettuccine Alfredo', 'This is a recipe that I created by modifying my mother\'s recipe.', 130, 1),
    ('Chocolate Chip Brownies', 'Best brownies I\'ve ever had!', 1232, 1),
    ('Cappuccino Brownies', 'Great, creamy brownies. Freeze great. Wonderful to give as Christmas presents to teachers and friends.', 123, 1),
    ('Baked Teriyaki Chicken', 'A much requested chicken recipe! Easy to double for a large group. Delicious!', 321, 1),
    ('Grandma\'s Apple Pie', 'Tastes like grandma...', 0, 1),
    ('Thai Beef', 'A delicious meal blending the flavors of salt and crushed dreams.', 0, 1),
    ('Hash Brownies', 'They taste funny...', 10, 1),
    ('Baked Chicken', 'Flavorful and moist baked chicken.', 11, 1),
    ('Chicken Pot Pie', 'Easy, beginner pot pie that not even your mother could love.', 42, 1),
    ('Stuffed Chicken Breast', 'This is a great dish for the fall.', 1337, 1);
